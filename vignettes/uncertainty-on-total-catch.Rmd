...
Figure \@ref(fig:standard) shows the acyclic directed graph (DAG) used in the conditional
...
appears in Figure \@ref(fig:stock-spec). Sampling in this new model proceeds exactly as before, except
...
And that posterior sample is distributed as shown in Figure \@ref(fig:rec3hist).
...
appears in Figure \@ref(fig:posthist).
