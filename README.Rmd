...
Rcpp, which in turn requires an Rtools installation (if you are on Windows)
...
well, suggesting that these is not too much weird stuff going on overall.  (That is good!)  
