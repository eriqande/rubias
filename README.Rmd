...
Here we use the `alewife` data to simulate 50 mixture samples of size 200 fish 
...
estimated, but have some variation.  For that we will want supply Dirichlet random variable
...
We'll scale them so that they sum to 10---that should give some variation, but not too much.  Accordingly
