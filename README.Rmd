...
rubias is an R package for performing genetic stock identification (GSI) and
...
[See Vignette](https://eriqande.github.io/rubias/docs/articles/uncertainty-on-total-catch.html)
2. Provide enhanced tools to understand whether mixing proportions $<\frac{1}{N}$ are the
...
[The vignette](https://eriqande.github.io/rubias/docs/articles/ppns-less-than-1-over-n.html)
about this also
suggests a decision-theoretic criterion for declaring some such mixture components as empty.


The CRAN version has not kept up with this version on GitHub, primarily because there
is an one chip/compiler combination upon which the fully-bayesian version code
